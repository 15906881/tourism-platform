    ...
    return (
      <button
        ...
        className={cn(
          ...
          variant === 'primary' && 'bg-primary text-bg hover:bg-primary-hover',
          ...
          variant === 'ghost' && 'bg-transparent text-text hover:bg-surface-2',
          size === 'sm' && 'px-sm py-xs text-sm',
          size === 'md' && 'px-md py-sm text-base',
